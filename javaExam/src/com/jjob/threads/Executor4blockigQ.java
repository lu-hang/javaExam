...
public class Executor4blockigQ {
	public static void main(String[] args)
    {
        ...
        while (true) {
            ...
            executor.execute(new DemoTask_bq(threadCounter.toString()));
...
class DemoTask_bq implements Runnable
{
    private String name = null;
 
    public DemoTask_bq(String name) {
        this.name = name;
    }
